...
LineExtractionROS2::LineExtractionROS2() : Node("laser_extraction_node")
{
  ...
  scan_subscriber_ = this->create_subscription<sensor_msgs::msg::LaserScan>(scan_topic_, rclcpp::SensorDataQoS(), std::bind(&LineExtractionROS2::laserScanCallback, this, std::placeholders::_1));
...
void LineExtractionROS2::loadParameters()
{
  ...
  this->declare_parameter("publish_markers", false);
